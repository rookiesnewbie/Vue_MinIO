        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleAdd"
              v-if="hasPermission('manage:employee:add')"
              >新增</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleImport"
              v-if="hasPermission('manage:employee:import')"
              >导入</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              v-if="hasPermission('manage:employee:export')"
              >导出</el-button
            >
          </el-col>
          <right-toolbar
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                v-if="hasPermission('manage:employee:update')"
                >修改</el-button
              >
              <el-dropdown
                @command="
                ...
                v-if="
                  hasPermission(
                    ...
                    'manage:employee:reset-password',
                    'manage:employee:assign-role'
                  )
                "
              >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item
                    ...
                    v-if="
                      scope.row.id !== 1 &&
                      hasPermission('manage:employee:delete')
                    "
                    size="mini"
                    type="text"
                    icon="el-icon-delete"
                  ...
                  <el-dropdown-item
                    ...
                    v-if="hasPermission('manage:employee:reset-password')"
                    size="mini"
                    type="text"
                    icon="el-icon-key"
                  ...
                  <el-dropdown-item
                    command="handleRole"
                    v-if="hasPermission('manage:employee:assign-role')"
                    size="mini"
                    type="text"
