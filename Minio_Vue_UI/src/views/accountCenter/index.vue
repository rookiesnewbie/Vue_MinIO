<template>
  <div class="app-container">
    <el-card style="padding: 5px 10px;margin-top: 20px;width: 80%; margin-left: 150px;">
      <el-form
      ...
      <el-form-item>
        <el-row :gutter="18">
         <!--  <el-col :span="6">
          ...
          <el-col :span="6">
            <el-button type="primary" @click.native.prevent="backHomePage">返回首页</el-button>
          </el-col>
        </el-row>
      </el-form-item>
    </el-form>
...
import { update as updateAccount, validatePassword } from '@/api/user'
