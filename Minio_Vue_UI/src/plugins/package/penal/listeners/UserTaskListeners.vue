...
export default {
  ...
  methods: {
    resetListenersList() {
      ...
      this.bpmnElementListeners = this.bpmnElement.businessObject && this.bpmnElement.businessObject.extensionElements &&
    ...
    async saveListenerConfig() {
      ...
      this.otherExtensionList = this.bpmnElement.businessObject && this.bpmnElement.businessObject.extensionElements &&
        this.bpmnElement.businessObject.extensionElements.values &&
        this.bpmnElement.businessObject.extensionElements.values.filter(ex => ex.$type !== `${this.prefix}:TaskListener`) || []
      updateElementExtensions(this.bpmnElement, this.otherExtensionList.concat(this.bpmnElementListeners))
      // 4. 隐藏侧边栏
