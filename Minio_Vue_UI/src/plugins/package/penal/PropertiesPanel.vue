...
export default {
  ...
  methods: {
    ...
    initFormOnChanged(element) {
      ...
      if (!activatedElement) {
        const temp = window.bpmnInstances.elementRegistry.find(el => el.type === 'bpmn:Process')
        // activatedElement =
        //   window.bpmnInstances.elementRegistry.find(el => el.type === "bpmn:Process") ??
        //   window.bpmnInstances.elementRegistry.find(el => el.type === "bpmn:Collaboration");
        activatedElement = (temp !== null && temp !== undefined) ? temp : window.bpmnInstances.elementRegistry.find(el => el.type === 'bpmn:Collaboration')
      }
