  ...
  methods: {
    getElementLoop(businessObject) {
      ...
      this.loopInstanceForm = {
        ...this.defaultLoopInstanceForm,
        ...businessObject.loopCharacteristics,
        completionCondition: businessObject.loopCharacteristics && businessObject.loopCharacteristics.completionCondition &&
          businessObject.loopCharacteristics.completionCondition.body || '',
        loopCardinality: businessObject.loopCharacteristics && businessObject.loopCharacteristics.loopCardinality &&
