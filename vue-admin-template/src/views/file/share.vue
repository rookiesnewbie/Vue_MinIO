<template>
  <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8" style="margin-bottom:10px">
        ...
        <el-col :span="1.5">
          <el-button type="primary" icon="el-icon-download" size="mini" @click="handleBatchDownload"
            :loading="exportLoading">批量下载</el-button>
        </el-col>
        <el-col :span="6">
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown @command="(command) => handleCommand(command, scope.$index, scope.row)">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="handleRename"  size="mini" type="text"
                  icon="el-icon-edit-outline">重命名</el-dropdown-item>
    ...
    <!-- 预览文件弹出框 -->
    <el-dialog :title="showFile.name" :visible.sync="dialogVisible" width="50%" style="height: 100vh;">
      <embed v-if="showFile.type === 'pdf'" :src="showFile.path" :type="showFile.contentType" width="100%" height="500">
...
import { getFileList, createFolder, renameFile, downloadFile, uploadFiles, removeFileToRecycleBin, previewFile } from '@/api/file'
